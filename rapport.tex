...
% grande route attend une voiture arrive petite route
% signal p envoyé quand t < 30
% attend r2

% r1 & r2 changer d'état que si un des feux est rouge

% petite route attend voiture + grande route  au rouge
% voiture peut passer quand la petite route est rouge -> au moins une voiture de passée
